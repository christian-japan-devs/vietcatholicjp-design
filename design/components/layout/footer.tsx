    ...
    return (
        <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
            <div className='flex sm:hidden'>
                <div className="btm-nav rounded-t-2xl border-t bg-base-200">
                    <button onClick={()=>router.push('/')} className={(current_page==='home'?'active':'')}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                        <span className="btm-nav-label">Trang chủ</span>
                    </button>
                    <button onClick={()=>router.push('/phung-vu')} className={(current_page==='serve'?'active':'')}>
                        ...
                        <span className="btm-nav-label">Phụng vụ</span>
                    </button>
                    <button onClick={()=>router.push('/cong-doan')} className={(current_page==='comunity'?'active':'')}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span className="btm-nav-label">Cộng đoàn</span>
                    </button>
                    <button onClick={()=>router.push('/lien-lac')} className={(current_page==='contact'?'active':'')}>
                        ...
                        <span className="btm-nav-label">Liên lạc</span>
                    </button>
                </div>
            </div>
