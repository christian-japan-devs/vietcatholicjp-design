                    ...
                    <div className="my-4 md:px-24 ms:my-12 relative w-full overflow-x-auto pb-8">
                        <form>
                            ...
                            <div className="mb-6 flex flex-row space-x-4">
                                ...
                                <button type="reset" className="text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800">Huỷ</button>
                            </div>
                        </form>
                    </div>
                </div>
