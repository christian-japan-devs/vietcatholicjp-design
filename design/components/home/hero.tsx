export default function Hero()
{
    return(
      <div className="sm:flex sm:flex-col sm:items-center">
        <div className="hidden md:block sm:justify-center pt-96 mx-2 mt-2 sm:pb-96 sm:pt-2 sm:px-12 lg:mx-12 md:max-w-3xl lg:max-w-6xl items-center bg-hero-index bg-cover bg-center border rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
