...
type Props = {
  schedules: MassDateSchedule[],
  is_home?: boolean
}

const MassSchedule: NextPage<Props> = ({schedules,is_home=true}) => {
  ...
  return(
    <div className="relative px-2 lg:px-8">
      ...
      <div key={idx} className="max-w-5xl lg:min-w-5xl bg-white border p-4 border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 md:flex md:flex-col md:items-center my-6 mx-auto px-4">
