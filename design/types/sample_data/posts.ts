...
export const sample_posts:PostCard[] = [
    ...
    },
    {
        ...
        slug:"huong-toi-mot-hoi-thanh-hiep-hanh",
        author:{
...
export const sample_gospel_video = [
    {
        link_id:"ZCVSCOt5J7k",
        published_date:"04/12/2022",
    },
    {
        link_id:"SyCxcnjm1_k",
        published_date:"29/11/2022",
    },
    {
        link_id:"qohFfmI1-UY",
        published_date:"22/11/2022",
    },{
        link_id:"2Phx4LKAZco",
        published_date:"04/08/2022",
    },
    {
        link_id:"CLWhmsBIEUo",
        published_date:"22/05/2022",
    }
    
]

export const sample_letter1={
    title:"Thư mục vụ",
    slug:"thu-muc-vu-12-2022",
    author:{
        full_name:"Lm. P.M Nguyen Huu Hien",
        image:'/youth_event/missa-01.jpg',
        user:{
    ...
    paragraph_1:"Anh chị em rất thân mến, Ngày 09 tháng 10 vừa qua, Đức Thánh Cha Phanxcô đã tuyên phong hiển thánh cho hai chân phước Gioan Baotixita Scalabrini, Giám Mục sáng lập Dòng Scalabrini và chân phước Artemide Zatti, trợ sĩ Dòng Salesio Don Bosco. Việc tuyên phong hiển thánh này nói lên ước nguyện của Hội Thánh trong hoàn cảnh hiện nay: thao thức săn sóc cho người di dân tỵ nạn và người nghèo.",
    paragraph_2:"Thánh Scalabrini đã lập ra một hội dòng chuyên môn lo lắng và chăm sóc cho người di dân và tỵ nạn. Ngày nay, thế giới đang đứng trước làn sóng đông đảo những người, vì hoàn cảnh chính trị, kinh tế, tôn giáo, phải bỏ quê hương, làng xóm, tỵ nạn đến những đất nước khác để may ra có thể có một cuộc sống tốt đẹp hơn. Nơi vùng đất tạm dung, họ phải trực diện với biết bao khó khăn, thách đố về ngôn ngữ, văn hóa, nhà cửa, công việc, và Giáo Hội, đặc biệt qua các tu sĩ dòng Scalabrini, là một khí cụ Chúa dùng để nâng đỡ anh chị em di dân, tỵ nạn.",
    date:"01/12/2022"
}
