            ...
            <section className="max-w-3xl mt-24 mx-auto px-4">
                ...
                <div className="flex flex-col mb-48 my-8 items-center">
                    <div className=" max-h-80 max-w-full rounded-xl ">
                        <div className="flex flex-col py-2 px-2 w-full item-center sm:mt-2 bg-gradient-to-r border-gray-100 from-cyan-500 to-blue-500 rounded-xl shadow-lg">
                            {startScanning?<QRcodeReader type={'checkin'} />:<></>}
                            <button
                                type='button'
